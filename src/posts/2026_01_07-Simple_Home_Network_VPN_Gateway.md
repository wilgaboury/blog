...
This blog post is going to explain how to setup a home network Wiregaurd VPN gateway, and hopefully teach some cool Linux networking technology along the way. This setup is meant to be dead simple, and just requires that you have a Linux computer with a wired ethernet connection to your router: the specification that it is wired is important.