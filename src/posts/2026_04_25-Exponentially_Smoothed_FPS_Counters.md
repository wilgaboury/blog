...
What we actually want is the average framerate over a fixed window of time. To do so, we will consider that we want our EMA to maintain a constant average age of datapoints $T$, therefore:
